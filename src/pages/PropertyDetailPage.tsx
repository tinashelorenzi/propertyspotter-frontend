                ...
                <div className="relative bg-white rounded-3xl p-8 shadow-xl">
                  ...
                  <div className="text-center">
                    ...
                    <h4 className="text-xl font-bold text-gray-900 mb-2">
                      {property.agent_name || 'PropertySpotter Team'}
                    </h4>
                    <p className="text-[#225AE3] font-semibold mb-6">
                      {property.agent_name ? 'PropertySpotter Agent' : 'PropertySpotter Sales Team'}
                    </p>
                    ...
                    <div className="space-y-3 text-gray-600">
                      <div className="flex items-center justify-center space-x-3">
                        ...
                        <span className="font-medium">
                          {property.agent_email || 'info@propertyspotter.co.za'}
                        </span>
                      </div>
                      <div className="flex items-center justify-center space-x-3">
                        <svg className="w-5 h-5 text-[#225AE3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span className="font-medium">
                          {property.agent_phone || '+27 79 855 7301'}
                        </span>
                      </div>
                    </div>
                  </div>

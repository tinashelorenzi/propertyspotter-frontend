            ...
            <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl p-8 md:p-10 shadow-xl border border-white/50">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="text-center space-y-2">
                  <p className="text-sm text-gray-500">Looking for agency access?</p>
                  <Link 
                    to="/agency-login" 
                    className="inline-flex items-center text-sm text-[#225AE3] hover:text-[#F59E0B] font-semibold transition-colors duration-200"
                  >
